...
def embed_text_for(product: Product) -> str:
    ...
    Phase 1 only stores titles. Phase 3 will mix in brand and category for
    sharper matches. For now, the cleaned title is enough to validate the
    pipeline and meets the Phase 2 exit criteria.
    """
